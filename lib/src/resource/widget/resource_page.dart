...
/// Resource Page to display [ResourceModel] from API.
class ResourcePage extends StatelessWidget {
  /// Displaying [ResourceModel].
    ...
    return InkWell(
        ...
        child: BlocBuilder<ResourceCubit, ResourceState>(builder: (_, state) {
          if (state is ResourceFailed) {
            //
            // Displaying Alert Icon and Error Message.
            //
            return Container(
            ...
            //
            // Displaying fetched ResourceModel from API.
            //
