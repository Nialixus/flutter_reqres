...
import 'package:flutter_reqres_test/src/widget/page/resource_page.dart';
import 'package:flutter_reqres_test/src/widget/page/user_page.dart';

export 'home_page.dart' hide contentTitle, header, resource, user;
...
Widget resource(BuildContext context, double width) => SizedBox(
      width: width,
      height: 125,
